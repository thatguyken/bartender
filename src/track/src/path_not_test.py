...
def main():
    ...
    #x, y, and z position
    goal_1.pose.position.x = -0.591
    goal_1.pose.position.y = 0.665
    goal_1.pose.position.z = 0.151
    ...
    #x, y, and z position
    goal_2.pose.position.x = 0.770
    goal_2.pose.position.y = 0.531
    goal_2.pose.position.z = 0.135
